...
const libnut_keyboard_action_class_1 = require("./libnut-keyboard-action.class");
...
describe("libnut keyboard action", () => {
    describe("click", () => {
        it("should forward the keyTap call to libnut for a known key", () => {
            // GIVEN
            const SUT = new libnut_keyboard_action_class_1.KeyboardAction();
            // WHEN
    ...
    describe("pressKey", () => {
        it("should forward the pressKey call to libnut for a known key", () => {
            ...
            expect(libnut.keyToggle).toBeCalledWith(libnut_keyboard_action_class_1.KeyboardAction.keyLookup(key_enum_1.Key.A), "down", []);
        });
        it("should treat a list of keys as modifiers + the actual key to press", () => {
            ...
            expect(libnut.keyToggle)
                .toBeCalledWith(libnut_keyboard_action_class_1.KeyboardAction.keyLookup(key_enum_1.Key.A), "down", [libnut_keyboard_action_class_1.KeyboardAction.keyLookup(key_enum_1.Key.LeftControl)]);
        });
    ...
    describe("releaseKey", () => {
        it("should forward the releaseKey call to libnut for a known key", () => {
            ...
            // THEN
            expect(libnut.keyToggle).toBeCalledTimes(1);
            expect(libnut.keyToggle).toBeCalledWith(libnut_keyboard_action_class_1.KeyboardAction.keyLookup(key_enum_1.Key.A), "up", []);
        });
        it("should treat a list of keys as modifiers + the actual key to release", () => {
            ...
            expect(libnut.keyToggle).toBeCalledTimes(1);
            expect(libnut.keyToggle)
                .toBeCalledWith(libnut_keyboard_action_class_1.KeyboardAction.keyLookup(key_enum_1.Key.A), "up", [libnut_keyboard_action_class_1.KeyboardAction.keyLookup(key_enum_1.Key.LeftControl)]);
        });
