...
const libnut_screen_action_class_1 = require("../provider/native/libnut-screen-action.class");
const image_writer_class_1 = require("../provider/opencv/image-writer.class");
const template_matching_finder_class_1 = require("../provider/opencv/template-matching-finder.class");
/**
...
class VisionAdapter {
     ...
     */
    constructor(finder = new template_matching_finder_class_1.TemplateMatchingFinder(), screen = new libnut_screen_action_class_1.ScreenAction(), dataSink = new image_writer_class_1.ImageWriter()) {
        this.finder = finder;
        this.screen = screen;
