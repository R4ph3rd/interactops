...
class NativeAdapter {
     ...
     */
    constructor(clipboard = new clipboardy_clipboard_action_class_1.ClipboardAction(), keyboard = new libnut_keyboard_action_class_1.KeyboardAction(), mouse = new libnut_mouse_action_class_1.MouseAction(), window = new libnut_window_action_class_1.WindowAction()) {
