...
const clipboardy_clipboard_action_class_1 = require("../provider/native/clipboardy-clipboard-action.class");
const libnut_keyboard_action_class_1 = require("../provider/native/libnut-keyboard-action.class");
const libnut_mouse_action_class_1 = require("../provider/native/libnut-mouse-action.class");
const native_adapter_class_1 = require("./native.adapter.class");
const libnut_window_action_class_1 = require("../provider/native/libnut-window-action.class");
...
describe("NativeAdapter class", () => {
    describe("MouseAction", () => {
        it("should delegate calls to setMouseDelay", async () => {
            // GIVEN
            const clipboardMock = new clipboardy_clipboard_action_class_1.ClipboardAction();
            const keyboardMock = new libnut_keyboard_action_class_1.KeyboardAction();
            const mouseMock = new libnut_mouse_action_class_1.MouseAction();
            const windowMock = new libnut_window_action_class_1.WindowAction();
