...
const poll_action_function_1 = require("./util/poll-action.function");
/**
...
class Screen {
    ...
    async find(templateImageFilename, params) {
        ...
        const searchRegion = (params && params.searchRegion) || await this.vision.screenSize();
        ...
        const matchRequest = new match_request_class_1.MatchRequest(screenImage, fullPathToNeedle, searchRegion, minMatch);
    ...
    async waitFor(templateImageFilename, timeoutMs = 5000, params) {
        return poll_action_function_1.timeout(500, timeoutMs, () => this.find(templateImageFilename, params));
    }
    /**
